...
public class EaglesDAO {
	...
	public List<EaglesDTO> selectPlayersByPosition(String posit) {
		String sql = "select * from eagles where posit like '" + posit + "';";
	...
	// public List<EaglesDTO> selectPlayersBysalary(int salary) {
	// String query = "select * from eagles where salary>=" + salary + ";";
	// PreparedStatement pStmt = null;
	// List<EaglesDTO> list = new ArrayList<EaglesDTO>();
	// try {
	// pStmt = conn.prepareStatement(query);
	...
	// String query = "select * from eagles where posit like '외야;";
	// PreparedStatement pStmt = null;
	// List<EaglesDTO> list = new ArrayList<EaglesDTO>();
	// try {
	// pStmt = conn.prepareStatement(query);
	...
	public void deleteEagles(int no) {
